from test_ui_evgeny_shit.locators import CreateAccountLocators as loc, SaleLocators as sale_loc, \
...
def test_click_submit_button(create_account_page):
    ...
    assert create_account_page.numer_of_items_is(5)
...
def test_cards_count(eco_friendly_page):
    ...
    assert eco_friendly_page.numer_of_items_is(12)
